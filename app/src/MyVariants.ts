...
export class MyVariants {
    public static getVariants(): OpeningVariant[] {
        ...
        const variants: OpeningVariant[] = [
            ...
            new OpeningVariant(
                'B01 Scandinavian Defense: Main Line - kingside pawn storm',
            ...
            new OpeningVariant(
                'C00 French Defense: Schlechter Variation',
            ...
            new OpeningVariant(
                'B04 Alekhine Defense: Modern Variation, Larsen Variation',
            ...
            new OpeningVariant(
                'D00 Queen\'s Pawn Game: Stonewall Attack',
            ...
            new OpeningVariant(
                'C13 French Defense: Alekhine-Chatard Attack, Maróczy Variation',
            ...
            new OpeningVariant(
                'C00 French Defense: La Bourdonnais Variation',
                '1. e4 e6 2. f4 d5 3. e5 c5 4. Nf3 Nc6 5. c3 Nh6 6. Na3 Nf5 7. Nc2 Be7 8. d4 cxd4 9. cxd4 Qb6',
                'black'
            ),
            new OpeningVariant(
                'C17 French Defense: Winawer Variation, Retreat Variation, Armenian Line',
